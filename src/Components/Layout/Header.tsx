...
/**
 *  TODO:   BUG-02 arreglar imagenes de pc y ipad pro se ven demasiado grandes y pc demasido chico
 */
...
export const Header = () => {
  ...
  return (
    <div className='padre-nav text-black dark:text-gray-100   '>


      <div className="navbar  bg-opacity-5 h-20 max-sm:w-11/12  ">
        ...
        <div className='navbar-end m-5'>
          <label className="swap swap-rotate  ">
            ...
            <input type="checkbox" className="theme-controller" value="synthwave" onClick={handleChangeTheme} />
